...
object LinearRegression {
  ...
  def main(args: Array[String]) {
    ...
    parser.parse(Array("D:\\myPlace\\Spark2.0Learnning\\src\\main\\resources\\regression\\sample_linear_regression_data.txt"), defaultParams) match {
